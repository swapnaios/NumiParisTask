...
class TopRatedVM {
    ...
    func getTopRatedData(completion:@escaping()->()){
        
        if NetworkReachability.isConnectedToNetwork(){
      
          guard let url = URL(string:"https://api.themoviedb.org/3/movie/top_rated?api_key=bac03cef82f59a88f1dcc24500d81de7&language=en-US&page=1") else {
            return
        }
